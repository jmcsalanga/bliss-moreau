...
expName = 'dot_probe_draft_4'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Bliss-Moreau Lab\\Desktop\\PlayingWithAOIs\\TEAS-master\\dot_probe_draft_4.py',
...
circ = visual.Circle(win=win, radius=25, units='pix',lineWidth=1, 
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        # *mouse_2* updates
        if t >= 0.525 and mouse_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            mouse_2.tStart = t
